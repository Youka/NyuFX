...
void GUI::CreateMenu(){
	...
	this->openviewMenu->Append(ID_MENU_OPEN_INCL, wxT("Includes") + wxT("\tF2"), _("Open include folder"));
	this->openviewMenu->Append(ID_MENU_OPEN_TMPL, wxT("Templates") + wxT("\tF3"), _("Open templates folder"));
	this->openviewMenu->Append(ID_MENU_OPEN_TOOLS, wxT("Tools") + wxT("\tF4"), _("Open tools folder"));
